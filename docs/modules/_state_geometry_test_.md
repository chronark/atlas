...
*Defined in [state/geometry.test.ts:7](https://github.com/chronark/atlas/blob/77d7c19/src/state/geometry.test.ts#L7)*
...
*Defined in [state/geometry.test.ts:15](https://github.com/chronark/atlas/blob/77d7c19/src/state/geometry.test.ts#L15)*
