...
*Defined in [src/state/geometry.test.ts:7](https://github.com/chronark/atlas/blob/198ad53/src/state/geometry.test.ts#L7)*
...
*Defined in [src/state/geometry.test.ts:15](https://github.com/chronark/atlas/blob/198ad53/src/state/geometry.test.ts#L15)*
