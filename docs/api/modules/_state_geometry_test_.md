...
*Defined in [src/state/geometry.test.ts:7](https://github.com/chronark/atlas/blob/3cdd76f/src/state/geometry.test.ts#L7)*
...
*Defined in [src/state/geometry.test.ts:15](https://github.com/chronark/atlas/blob/3cdd76f/src/state/geometry.test.ts#L15)*
