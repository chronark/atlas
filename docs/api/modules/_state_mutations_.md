...
*Defined in [state/mutations.ts:7](https://github.com/chronark/atlas/blob/b457830/src/state/mutations.ts#L7)*
...
*Defined in [state/mutations.ts:9](https://github.com/chronark/atlas/blob/b457830/src/state/mutations.ts#L9)*

###  addGeometries

▸ **addGeometries**(`state`: [State](_state_store_.md#state), `payload`: Geometry[]): *boolean*

*Defined in [state/mutations.ts:10](https://github.com/chronark/atlas/blob/b457830/src/state/mutations.ts#L10)*
...
*Defined in [state/mutations.ts:16](https://github.com/chronark/atlas/blob/b457830/src/state/mutations.ts#L16)*
...
*Defined in [state/mutations.ts:22](https://github.com/chronark/atlas/blob/b457830/src/state/mutations.ts#L22)*
...
*Defined in [state/mutations.ts:27](https://github.com/chronark/atlas/blob/b457830/src/state/mutations.ts#L27)*

###  setJobs

▸ **setJobs**(`state`: [State](_state_store_.md#state), `payload`: [Job](../interfaces/_types_customtypes_.job.md)[]): *boolean*

*Defined in [state/mutations.ts:28](https://github.com/chronark/atlas/blob/b457830/src/state/mutations.ts#L28)*
...
*Defined in [state/mutations.ts:32](https://github.com/chronark/atlas/blob/b457830/src/state/mutations.ts#L32)*
...
*Defined in [state/mutations.ts:37](https://github.com/chronark/atlas/blob/b457830/src/state/mutations.ts#L37)*
