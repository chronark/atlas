...
*Defined in [state/store.ts:9](https://github.com/chronark/atlas/blob/eb59b04/src/state/store.ts#L9)*
...
*Defined in [state/store.ts:26](https://github.com/chronark/atlas/blob/eb59b04/src/state/store.ts#L26)*
...
*Defined in [state/store.ts:93](https://github.com/chronark/atlas/blob/eb59b04/src/state/store.ts#L93)*
