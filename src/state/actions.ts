...
export default {
  ...
  selectCountries(ctx: Store, payload: Record<string, any>[]): void {
    ctx.commit("selectCountries", payload)
  },
  unselectCountries(ctx: Store, payload: Record<string, any>[]): void {
    ctx.commit("unselectCountries", payload)
  },
}
